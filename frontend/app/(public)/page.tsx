...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    description: 'Robotic-enhanced intelligent conveyor systems and bulk handling solutions.',
    alternates: { canonical: BASE_URL },
    openGraph: {
      type: 'website', url: BASE_URL,
      title: 'Kali MHS | Bulk Material Handling Solutions',
      description: "India's trusted manufacturer of premium material handling systems.",
      images: [{ url: '/og-default.jpg', width: 1200, height: 630, alt: 'Kali MHS' }],
    },
  };
}
...
export default async function Home() {
  ...
  const hero = cms?.hero ?? {
    ...
    subtitle: 'Robotic-enhanced intelligent conveyor systems and bulk handling solutions.',
